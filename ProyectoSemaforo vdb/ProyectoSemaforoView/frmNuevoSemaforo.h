...
namespace ProyectoSemaforoView {
	...
	/// <summary>
	/// Summary for frmNuevoSemaforo
	/// </summary>
	public ref class frmNuevoSemaforo : public System::Windows::Forms::Form
	{
	public:
		frmNuevoSemaforo(void)
		{
			InitializeComponent();
			//
		...
		frmNuevoSemaforo(GestorSemaforo^ objGestorSemaforo) {
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(133, 427);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(85, 30);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Grabar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &frmNuevoSemaforo::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Nuevo Semáforo";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(335, 95);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(126, 22);
			this->textBox1->TabIndex = 2;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &frmNuevoSemaforo::textBox1_TextChanged);
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(259, 98);
			...
			this->dataGridView1->Location = System::Drawing::Point(94, 222);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(580, 273);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(88, 47);
			this->button2->TabIndex = 6;
			this->button2->Text = L"Agregar LED";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &frmNuevoSemaforo::button2_Click);
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(185, 157);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(335, 154);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(332, 427);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(85, 30);
			this->button3->TabIndex = 9;
			this->button3->Text = L"Modificar";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &frmNuevoSemaforo::button3_Click);
			// 
			// button4
			// 
			this->button4->Location = System::Drawing::Point(538, 427);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(85, 30);
			this->button4->TabIndex = 10;
			this->button4->Text = L"Eliminar";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &frmNuevoSemaforo::button4_Click);
			// 
			// frmNuevoSemaforo
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(752, 521);
			...
			this->Name = L"frmNuevoSemaforo";
			this->Text = L"frmNuevoSemaforo";
			this->Load += gcnew System::EventHandler(this, &frmNuevoSemaforo::frmNuevoSemaforo_Load);
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (this->textBox1->Text != "") { //Validamos que se haya ingresado un codigo
			...
			for (int i = 0; i < this->objGestorSemaforo->ObtenerCantSemaforos(); i++) {
				...
				if (codigo == objSemaforoComp->codigo) {
					codigoValido = 0;
					break;
				}
			}
		...
		if (codigoValido == 1) {
			...
			MessageBox::Show("Error, ya hay un semaforo con ese código");
		}
		...
		if (this->objGestorLED->ObtenerCantLEDS() == 4) { //Validamos que se hayan ingresado todos los LEDs
			...
			for (int i = 0; i < this->objGestorLED->ObtenerCantLEDS(); i++)
			{
				...
				objLED->codigo = Convert::ToInt32(this->textBox1->Text); //Asignamos el codigo del semaforo a los LEDs
		...
		if (valido == 3) { //Si todo lo demas fue validado entonces se guarda el objeto en el gestor
			...
			MessageBox::Show("El semáforo fue agregado exitosamente");
			this->Close();
		}
	}
			 //Agregar LED
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		if (this->textBox1->Text != "") { //Validamos que se haya ingresado un codigo para el semaforo
...
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
	if (this->dataGridView1->SelectedRows->Count != 0) { //Vemos si se ha seleccionado una fila
		...
		MessageBox::Show("Seleccione una fila");
		 ...
		 //Sin funcion
private: System::Void frmNuevoSemaforo_Load(System::Object^  sender, System::EventArgs^  e) {
